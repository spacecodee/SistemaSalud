...
public class jdUsuariosCRUD extends javax.swing.JDialog {

    ctrlUsuario ctrlUsu = new ctrlUsuario();
    String verificar = "Agregar";

    public jdUsuariosCRUD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        ctrlUsu.mostrarEscuela(tblUsuarios);
    }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1240, 686));
        setMinimumSize(new java.awt.Dimension(1240, 686));
        setPreferredSize(new java.awt.Dimension(1240, 686));
        setResizable(false);
        ...
        txtNombres.setBounds(940, 180, 260, 46);
        ...
        btnAgregar.setBounds(820, 360, 396, 60);
        ...
        btnEliminar.setBounds(820, 450, 396, 60);
        ...
        jLabel2.setBounds(780, 180, 143, 46);
        ...
        txtBuscar.setBounds(40, 40, 717, 46);
        getContentPane().add(lblID);
        lblID.setBounds(680, 540, 74, 23);
        ...
        btnLimpiar.setBounds(820, 530, 390, 60);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (evt.getSource() == btnAgregar) {
            ...
            if (verificar.equals("Actualizar")) {
                ctrlUsu.actualizarUsuario(lblID, txtDNI, txtNombres, txtTelefono);
                ctrlUsu.mostrarEscuela(tblUsuarios);
                verificar = "Actualizar";
            } else if (verificar.equals("Agregar")) {
                ctrlUsu.agregUsuario(lblID, txtDNI, txtNombres, txtTelefono);
                ctrlUsu.mostrarEscuela(tblUsuarios);
                verificar = "Agregar";
            }
        }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        if (evt.getSource() == txtBuscar) {
            ctrlUsu.buscarUsuario(txtBuscar, tblUsuarios);
        }
    }//GEN-LAST:event_txtBuscarKeyReleased

    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        if (evt.getSource() == tblUsuarios) {
            ctrlUsu.pasarUsuario(tblUsuarios, lblID, txtDNI, txtNombres, txtTelefono);
            verificar = "Actualizar";
        }
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        if (evt.getSource() == btnLimpiar) {
            ctrlUsu.limpiarCajas(lblID, txtDNI, txtNombres, txtTelefono);
            verificar = "Agregar";
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (evt.getSource() == btnEliminar) {
            int fila = tblUsuarios.getSelectedRow();
            if (fila > 0) {
                ctrlUsu.eliminarUsuario(lblID, tblUsuarios);
                ctrlUsu.limpiarCajas(lblID, txtDNI, txtNombres, txtTelefono);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdUsuariosCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdUsuariosCRUD dialog = new jdUsuariosCRUD(new javax.swing.JFrame(), true);
